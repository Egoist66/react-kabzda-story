    ...
    <div>
      ...
      <div style={{display: 'flex', gap: 30, marginBottom: 20}}>
        <div>
          ...
          <input checked={isColored} onChange={() => setColor(true)} id={id1} type="radio" name="color" />
        </div>

        <div>
          <label htmlFor={id2}>Blue</label>
          <input checked={isColored} onChange={() => setColor(false)} id={id2} type="radio" name="color" />
        </div>
      </div>
